...
<head>
 ...
 -->
    <link rel="shortcut icon" href="public/img/GBAF-favicon.png" type="image/x-icon">
...
<body>
    ...
    <header class="header-main">
                    <div class="header__logo">
                        <a href="index.php"><img src="public/img/GBAF-logo.jpg" alt="logo-gbaf" title="Groupement Banque Assurance Français"></a>
                    </div>
