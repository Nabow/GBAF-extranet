    ...
    <section class="liste-article container">
        ...
        <div class="commentaires box">
            ...
            <div class="formulaire-com">
                ...
                <div class="vote" id="choix-<?= $class_vote_user ?>">
                    ...
                    <a href="article.php?vote=0&id_acteur=<?= $id_acteur ?>" class="vote-non">
                        <svg class="icon">
                            <use xlink:href="svg/sprite.svg#vote-non"></use>
                        </svg><?= $vote_non ?>
                    </a>
                </div>
                ...
                <form action="article.php?id_acteur=<?= $id_acteur ?>" method="post">
                    ...
                    <p><input class="bouton" name="ok" type="submit"
                            value="<?= (empty($modif_commentaire)) ? 'Envoyer' : 'Modifier' ; ?>"></p>
                </form>
            </div>
            ...
            <div class="liste-com">
                ...
                <div
                    class="commentaire-n<?php if($commentaire -> id_user === $id_user){echo " commentaire-auteur";} ?>">
                    <p class="auteur"><strong><?= $commentaire -> username ?></strong> le
                        <?= $commentaire -> date_post ?></p>
